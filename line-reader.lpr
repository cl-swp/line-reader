;; -*- lisp-version: "10.1 [64-bit Windows *SMP*] (Jul 29, 2023 14:04)"; -*-

(in-package :cg-user)

(define-project :name :line-reader
  :modules (list (make-instance 'module :name "line-reader.lisp"))
  :projects nil
  :libraries nil
  :editable-files nil
  :distributed-files (list "line-reader.asd" "linetest.txt")
